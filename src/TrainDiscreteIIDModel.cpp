...
namespace tops {
  ...
  ProbabilisticModelPtr TrainDiscreteIIDModel::create( ProbabilisticModelParameters & parameters, const std::vector<std::string> & sample_set, double & loglikelihood, int & sample_size) const {
...
ProbabilisticModelPtr TrainDiscreteIIDModel::train(const SequenceEntryList & sample_set, AlphabetPtr alphabet) const{
        ...
        tree->normalize();
        DiscreteIIDModelPtr m = tree->getRoot()->getDistribution();
        m->setAlphabet(alphabet);
        return m;
  }

  ProbabilisticModelPtr TrainDiscreteIIDModel::create(
  ...
  ProbabilisticModelPtr TrainDiscreteIIDModel::create(
   ...
   std::string TrainDiscreteIIDModel::help() const   {
      ...
      out << "\ttraining_algorithm=\"DiscreteIIDModel\"" << std::endl;
