/*
 *       ProfileHiddenMarkovModelCreator.cpp
 *
...
namespace tops {
  ProbabilisticModelPtr ProfileHiddenMarkovModelCreator::create(ProbabilisticModelParameters & parameters) const {
    ...
    ProbabilisticModelPtr model = ProfileHiddenMarkovModelPtr(new ProfileHiddenMarkovModel());
