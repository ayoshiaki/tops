/*
 *       ProfileHiddenMarkovModelCreator.hpp
 *
...
#ifndef PROFILE_HIDDEN_MARKOV_MODEL_CREATOR_HPP
#define PROFILE_HIDDEN_MARKOV_MODEL_CREATOR_HPP
...
namespace tops {
  ...
  class DLLEXPORT ProfileHiddenMarkovModelCreator : public ProbabilisticModelCreator
  {
  public:
    ProfileHiddenMarkovModelCreator() {}
    virtual ~ProfileHiddenMarkovModelCreator(){};
  ...
  typedef boost::shared_ptr < ProfileHiddenMarkovModelCreator> ProfileHiddenMarkovModelCreatorPtr;
}
