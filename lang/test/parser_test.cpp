...
TEST(AST, Parser) {
  ...
  EXPECT_EQ("(ConfigurationNode (PropertyNode (KeyNode p0) (ProbabilityMapNode (ProbabilityNode (StringNode A) (FloatNode 0.2)) (ProbabilityNode (StringNode C) (FloatNode 0.2)) (ProbabilityNode (StringNode G) (FloatNode 0.2)) (ProbabilityNode (StringNode T) (FloatNode 0.4)))))", 
  ...
  EXPECT_EQ("(ConfigurationNode (PropertyNode (KeyNode p0) (ProbabilityMapNode (ProbabilityNode (StringNode A) (IntegerNode 0)) (ProbabilityNode (StringNode C) (FloatNode 0.181818)) (ProbabilityNode (StringNode G) (FloatNode 0.636364)) (ProbabilityNode (StringNode T) (FloatNode 0.181818)))))", 
           parse("p0 = (\"A\" : 0; # leaf \n \"C\" : 0.181818; # leaf \n \"G\" : 0.636364; # leaf \n \"T\" : 0.181818; # leaf \n )")->str());
